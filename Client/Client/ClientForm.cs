...
namespace Ch.Elca.Iiop.Demo.Chatroom {
    ...
    public class Chatform : System.Windows.Forms.Form {
        ...
        private IChatroom m_chatroom = null;
        ...
        private void m_sendMsgButton_Click(object sender, System.EventArgs e) {
            if (m_listener != null) {
                ...
                try {
                    m_chatroom.BroadCast(new Message(m_listener.UserName, m_messageTextbox.Text));
                } catch (Exception ex) {
        ...
        internal void AddMessage(Message newMessage) {
            ...
            string entry = "[" + newMessage.Originator + "] " + newMessage.Msg;
